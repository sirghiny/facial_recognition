...
def create_pairs(sample_size):
    ...
    paths = load(open('data/more_than_one.pkl', 'rb'))
...
def load_data(sample_size):
    ...
    return x_train1, x_test1, y_train, x_test1, x_test2, y_test

x_train1, x_test1, y_train, x_test1, x_test2, y_test = load_data(1000)
